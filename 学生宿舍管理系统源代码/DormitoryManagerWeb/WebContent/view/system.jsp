...
<head>
    ...
    <link rel="shortcut icon" href="xuexiao.png"/>
	<link rel="bookmark" href="xuexiao.png"/>
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        background: url(images/layout-browser-hd-bg.gif) #CC3333 repeat-x center 50%;
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体">
        <span style="float:right; padding-right:20px;" class="head"><span style="color:#FFFFCC font-weight:bold;font-size:150%">${user.name}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="SystemServlet?method=LoginOut" id="loginOut">安全退出</a></span>
